...
<body>
  <div>
    ...
    <p style="font-size:10px;padding-left:95px;"><b>State university | Re-accredited with "A" Grade By NACC | Ranked
        13th among Indian Universities by MHRD-NIRF</b></p>
  ...
  <table class="table table-bordered">
    <tbody>
      ...
      <tr>
        <td colspan="2">Whether,the previouse enrolment card is attested.</td>
        @if($show->enrol_check)
        <td>Yes</td>
        @else
        <td> No</td>
      ...
      <tr>
        <td colspan="2">Date of Registration as per in the enrolment card</td>
        <td>
          {{date('d-m-Y', strtotime($show->data_of_registration))}}
        </td>
      </tr>
      <tr>
        <td colspan="2">Registration Number as per in the enrolment card</td>
        <td>
